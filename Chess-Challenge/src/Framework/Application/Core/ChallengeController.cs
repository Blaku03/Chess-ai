...
namespace ChessChallenge.Application
{
    public class ChallengeController
    {
        ...
        public void StartNewGame(PlayerType whiteType, PlayerType blackType)
        {
            ...
            //board.LoadPosition("2k5/4q3/8/6p1/6P1/4Q3/2K5/8 w - - 0 1");
            //board.LoadPosition("k7/2PR1N2/PKPP4/PPP3p1/6P1/8/8/8 w - - 0 1");
            //mate in two
            //board.LoadPosition("r2qkb1r/pp2nppp/3p4/2pNN1B1/2BnP3/3P4/PPP2PPP/R2bK2R w KQkq - 1 0");
            //mate in three
            //board.LoadPosition("6k1/R7/2r5/4pR2/2p1P3/2r3P1/5PP1/6K1 b - - 0 1"); 
